...
CREATE TABLE `cucian` (
  ...
  `nama_konsumen` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `nohp_konsumen` varchar(13) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `pengguna` (
  `id_pengguna` int NOT NULL,
  `nama_pengguna` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `peran` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `kata_sandi` varchar(60) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
